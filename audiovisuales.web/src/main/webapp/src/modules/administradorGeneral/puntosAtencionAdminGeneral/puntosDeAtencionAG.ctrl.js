...
(function (ng) {
    ...
    mod.controller("puntosDeAtencionAGCtrl", ['$scope', '$state', '$stateParams', '$http', 'puntosDeAtencionContext', function ($scope, $state, $stateParams, $http, context) {
                ...
                if (id == null) {
                    ...
                    return $http.post(context, currentRecord)
                        .then(function () {
                            ...
                            $state.go('adminGeneralPuntosDeAtencion');
                        }, responseError);
